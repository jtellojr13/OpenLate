...
#define FS2_OAUTH_KEY    (@"NLSHHMVEXKBWCEMKKFOOOTEQ0X5E5PQOXNGJGUJVJA45PZCU")
#endif

#ifndef FS2_OAUTH_SECRET
#define FS2_OAUTH_SECRET (@"3SYHZGUWM2AMJZ3YOADFNW3FOPPINPENZ2JXGX2T35NQLLNH")
#endif
...
#define FS2_API_VERSION (@"20130522")
#endif
